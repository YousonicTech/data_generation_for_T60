...
parser.add_argument('--Speaker_root', default='/data1/zdm/code/T60_data_generation/test/ChineseCatClean/', type=str)
parser.add_argument('--Speaker_txt', default='/data1/zdm/code/T60_data_generation/test/ChineseCatClean/CatChinese.txt', type=str)
