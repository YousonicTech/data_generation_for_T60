...
parser.add_argument('--Speaker_root', default='/data1/zdm/speech/CatLiveSpeech/', type=str)
parser.add_argument('--Speaker_txt', default='/data1/zdm/speech/CatLiveSpeech/CatLiveSpeech.txt', type=str)
